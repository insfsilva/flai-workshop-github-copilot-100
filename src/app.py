...
activities = {
    ...
    "Soccer Team": {
        "description": "Join the school soccer team for practice and competitive matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 25,
        "participants": ["lucas@mergington.edu", "mia@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Improve your swimming techniques and compete in swim meets",
    ...
    "Science Olympiad": {
        "description": "Compete in scientific challenges and experiments across various disciplines",
